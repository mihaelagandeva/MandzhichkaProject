...
const RestaurantSchema = new mongoose.Schema({
    name: {
        type: String,
        required: [true, 'Името на рестораната е задължително'],
        minlength: [3, 'Името на рестораната трябва да е дълго поне 3 символа'],
        maxlength: [100, 'Името на рестораната е твърде дълго']
    },
    address: {
        type: String,
